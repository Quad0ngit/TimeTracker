...
public partial class Login_aspx : System.Web.UI.Page
{
    ...
    protected void Login1_LoggedIn(object sender, EventArgs e)
    {
        ...
        Session["username"] = Login1.UserName.ToUpper().Substring(0, 1) + Login1.UserName.ToLower().Substring(1);
       // Session["username"] = Login1.UniqueID;
        Response.Redirect("~/TimeTracker/TimeEntry.aspx",true);
        return;
    }
}
