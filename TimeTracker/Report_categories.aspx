<%@ Page Language="C#" MasterPageFile="~/TimeTracker/MasterPage.master" CodeFile="Report_categories.aspx.cs"
    Inherits="Report_categories_aspx" Title="Quadone - Time Tracker - Create Category wise Reports" Culture="auto" UICulture="auto"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    ...
    <div id="projectreportnew">
        ...
        <fieldset>
           ...
           <div>
                <asp:Label ID="Label1" runat="server" Text="Label" AssociatedControlID="CategoryList">Select a Category. Use ctrl+click to Select multiple Categories at once:</asp:Label>
                
                <br /><br />
                <div class="left_select">
                <asp:ObjectDataSource ID="CategoryData" runat="server" 
                        TypeName="ASPNET.StarterKit.BusinessLogicLayer.Category" >
                    </asp:ObjectDataSource>
                <asp:ListBox ID="CategoryList" runat="server" SelectionMode="Multiple" 
                        CssClass="resourcelist" AutoPostBack="true"
                    Width="200px" Height="330px" Rows="22" 
                        onselectedindexchanged="CategoryList_SelectedIndexChanged"  />
                <br/>
                <asp:RequiredFieldValidator ID="CategoryListRequiredFieldValidator" runat="server" Width="223px"
                    ErrorMessage="At least one Category must be selected." ControlToValidate="CategoryList"
            ...
            <div class="report-by-month">
                ...
                <tr>
                <td><asp:Label ID="Label3" Text="Select Month:" runat="server"></asp:Label></td>
                 <td>
            ...
            <div class="report-by-date">
                ...
                <asp:Label ID="FromDate" Text="From Date:" runat="server"></asp:Label>
                 ...
                 <td width="25%">
                  <asp:TextBox ID="StartDate" runat="server"></asp:TextBox> <span>[mm/dd/yyyy]</span>
                 </td>
                 ...
                 <tr><td colspan="4" align="right"><asp:Button ID="GenProjectRpt" runat="server" CssClass="submit" Text="Generate Report"
                CausesValidation="False" OnClick="GenCategoryRpt_Click" /></td></tr>
                 <tr>
                 <td></td>
                 <td>   
