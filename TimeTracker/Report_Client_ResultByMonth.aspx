<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Client_ResultByMonth.aspx.cs" Inherits="TimeTracker_Report_Client_ResultByMonth" MasterPageFile="~/TimeTracker/MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
   ...
   <div id="projectreport">
        ...
        <fieldset>
          ...
          <%--  <asp:ObjectDataSource ID="ProjectReportData" runat="server" TypeName="ASPNET.StarterKit.BusinessLogicLayer.CustomFacade"
                SelectMethod="GetClientReportByIdAndMonthAndYear">
                <SelectParameters>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="Content project_main_list" width="100%">
                        ...
                        <tr>
                            ...
                            <asp:ObjectDataSource ID="UserReportData" runat="server" TypeName="ASPNET.StarterKit.BusinessLogicLayer.UserReport"
                                   SelectMethod="GetClientWiseUserReportsByProjectIdAndMonthAndYear">
                                        <SelectParameters>
                                          <asp:SessionParameter Name="ProjectIds" SessionField="SelectedProjectIds" Type="Int32" />
                                          <asp:SessionParameter Name="Month" SessionField="SelectedMonthValue" Type="Int32" />
                                          <asp:SessionParameter Name="Year" SessionField="SelectedYear" Type="Int32" />
                                        </SelectParameters>
                               </asp:ObjectDataSource>
                                <asp:DataList ID="EntryList" CssClass="report_project" RepeatColumns="1" RepeatDirection="Vertical" Width="100%" runat="server" >
                                    <HeaderTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" class="Content" width="100%">
                                            <tr>
