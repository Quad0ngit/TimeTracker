<%@ Page Language="C#" MasterPageFile="~/TimeTracker/MasterPage.master" CodeFile="Report_Resources_Result.aspx.cs"
    Inherits="Report_Resources_Result_aspx" Title="Quadone - Time Tracker - Resource Reports" Culture="auto" UICulture="auto" EnableEventValidation="false"  %>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:GridView ID="ListUserTimeEntries" CssClass="project_main_list" 
                                                ...
                                                runat="server" 
                                                BorderStyle="None" Width="100%" CellPadding="0" 
