...
namespace ASPNET.StarterKit.BusinessLogicLayer {
  public class Category {
    ...
    public static List<Category> GetCategoriesByUserName(string UserName)
    {
        

        DataAccess DALLayer = DataAccessHelper.GetDataAccess();
        return (DALLayer.GetCategoriesByUserName(UserName));
    }
    ...
    public static List<Category> GetCategoriesBycategoryIds(string CategoryIds)
    {
        ...
        char[] separator = new char[] { ',' };
        string[] substrings = CategoryIds.Split(separator);// ,true);
        List<Category> list = new List<Category>();
        ...
        foreach (string str in substrings)
        {
            if (!string.IsNullOrEmpty(str))
            {
                ...
                Category tempList = Category.GetCategoryByCategoryId(id);
               list.Add(tempList);
